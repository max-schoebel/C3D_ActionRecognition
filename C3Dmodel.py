...
def inference(vid_placeholder, batch_size, dropout_rate, num_classes, collection):
    ...
    with tf.variable_scope('convlayer1') as scope:
        conv1 = conv3d(vid_placeholder, weight_dict['wconv1'](scope), bias_dict['bconv1'](scope), ('conv1', 'relu1'))
